            ...
            <Grid item xs={12} md={6}>
              ...
              <List>
                ...
                <ListItem sx={{ px: 0 }}>
                  ...
                  <ListItemText
                    primary="Ecosystem-based Adaptation"
                    secondary="Using natural systems and processes to help wildlife adapt to climate change impacts."
                    sx={{
                      "& .MuiListItemText-primary": {
                        fontWeight: 600,
                        fontSize: { xs: "0.9rem", sm: "1rem", md: "1.1rem" },
                ...
                <ListItem sx={{ px: 0 }}>
                  ...
                  <ListItemText
                    ...
                    secondary="Involving local communities in wildlife conservation efforts and recognizing their traditional knowledge."
                    sx={{
                      "& .MuiListItemText-primary": {
                        fontWeight: 600,
                        fontSize: { xs: "0.9rem", sm: "1rem", md: "1.1rem" },
                ...
                <ListItem sx={{ px: 0 }}>
                  ...
                  <ListItemText
                    primary="Collaborative Approaches"
                    secondary="Working with governments, NGOs, and other stakeholders to develop comprehensive conservation strategies."
                    sx={{
                      "& .MuiListItemText-primary": {
                        fontWeight: 600,
                        fontSize: { xs: "0.9rem", sm: "1rem", md: "1.1rem" },
